...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET CLI11::CLI11
                 ...
                 $<$<CONFIG:Release>:${cli11_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET CLI11::CLI11
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${cli11_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET CLI11::CLI11
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${cli11_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET CLI11::CLI11
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${cli11_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET CLI11::CLI11
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${cli11_COMPILE_OPTIONS_RELEASE}> APPEND)
